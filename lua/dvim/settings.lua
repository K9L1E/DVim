...
M.load_default_options = function()
  ...
  local default_options = {
    ...
    showtabline = 0, -- never show tabline
    ...
    laststatus = 2, -- make statusline cover the entire bottom
    ...
    virtualedit = "all", -- allow cursor to move where there is no text in visual block mode
